...
def create_nowpayments_invoice(amount_uah, order_id, product_name, pay_currency="usdtsol"):
    ...
    # Убедимся, что amount_uah является числом (int)
    try:
    ...
    payload = {
        ...
        "success_url": "https://t.me/SecureShopBot",  # URL после успешной оплаты
        "cancel_url": "https://t.me/SecureShopBot",  # URL после отмены оплаты
    }
