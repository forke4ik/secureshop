...
async def pay_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    context.user_data['pending_order_from_pay'] = {
        'order_id': order_id,
        'items': [{'service_name': 'Parsed Item', 'plan_name': 'Parsed Plan', 'period': item['period'], 'price': item['price'], 'type': 'unknown'} for item in parsed_items],
        'total_uah': total_uah,
        'original_command_args': context.args
    }
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("₿ Оплатити криптовалютою", callback_data=f"pay_crypto_cmd_{total_uah}")],
        [InlineKeyboardButton("📋 Головне меню", callback_data="back_to_main")],
    ]
